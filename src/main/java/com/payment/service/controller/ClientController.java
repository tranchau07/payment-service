...
public class ClientController {
    ...
    public ResponseEntity<com.payment.service.dto.response.ClientHierarchyResponse> getClientHierarchy(@PathVariable Long id) {
        log.info("Received request to fetch hierarchy tree for client ID: {}", id);
        return ResponseEntity.ok(clientService.getClientHierarchy(id));
    }
