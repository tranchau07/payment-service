...
tags = [
    "<wsin:HardwareType>STD</wsin:HardwareType>",
    "<wsin:HardwareTypeCode>STD</wsin:HardwareTypeCode>",
    "<wsin:Hardware>STD</wsin:Hardware>",
    "<wsin:HardwareId>STD</wsin:HardwareId>",
    "<wsin:Device>STD</wsin:Device>",
    "<wsin:Terminal>STD</wsin:Terminal>",
    "<wsin:TerminalType>STD</wsin:TerminalType>",
    "<wsin:TerminalTypeCode>STD</wsin:TerminalTypeCode>",
    "<wsin:TermCat>N</wsin:TermCat>",
...
def run_tests():
    for tag in tags:
        ...
        with open("temp_tag_test.xml", "w", encoding="utf-8") as f:
            f.write(xml_data)
        ...
        try:
            ...
            output = res.stdout
            if "Fault" in output:
                print("  Failed: SOAP Fault (Schema Mismatch / Invalid Tag)")
            else:
