...
variations = [
    "DEVICE_TYPE__ID=33;TERMINAL_ID=99999901;",
    "DEVICE_TYPE_ID=33;TERMINAL_ID=99999901;",
    "DEVICE_TYPE=33;TERMINAL_ID=99999901;",
    "DEVICE_TYPE=STD;TERMINAL_ID=99999901;",
    "DEVICE_TYPE__ID=33;TERMINAL_ID=99999901;TERM_CAT=N;",
    "DEVICE_TYPE=33;TERMINAL_ID=99999901;TERM_CAT=N;",
    "DEVICE_TYPE__ID=33;TERMINAL_ID_CODE=99999901;",
    "DEVICE_TYPE=33;TERMINAL_ID_CODE=99999901;"
]
    ...
    for var in variations:
        ...
        try:
            ...
            if "I Successfully Completed" in output or "CreatedContract" in output:
                ...
                # print error message from XML response
